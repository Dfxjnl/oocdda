...
#define DRINK(name, rarity, price, color, container, quench, nutr, spoils, stim, healthy, addict,  \
    ...
    itypes.push_back(new it_comest(index, rarity, price, name, des, '~', color, LIQUID, 2, 1, 0,   \
                                   0, 0, quench, nutr, spoils, stim, healthy, addict, charges,     \
...
#define FOOD(name, rarity, price, color, mat1, container, volume, weight, quench, nutr, spoils,    \
    ...
    itypes.push_back(new it_comest(index, rarity, price, name, des, '%', color, mat1, volume,      \
                                   weight, 0, 0, 0, quench, nutr, spoils, stim, healthy, addict,   \
                                   charges, fun, container, itm_null, use_func, addict_func));
    // FOOD
...
#define MED(name, rarity, price, color, tool, mat, stim, healthy, addict, charges, fun, use_func,  \
    ...
    itypes.push_back(new it_comest(index, rarity, price, name, des, '!', color, mat, 1, 1, 0, 0,   \
                                   0, 0, 0, 0, stim, healthy, addict, charges, fun, itm_null,      \
                                   tool, use_func, addict_func));
...
#define MELEE(name, rarity, price, sym, color, mat1, mat2, volume, wgt, dam, cut, to_hit, des)     \
    index++;                                                                                       \
    itypes.push_back(new itype(index, rarity, price, name, des, sym, color, mat1, mat2, volume,    \
                               wgt, dam, cut, to_hit))
...
#define ARMOR(name, rarity, price, color, mat1, mat2, volume, wgt, dam, to_hit, encumber,          \
    ...
    itypes.push_back(new it_armor(index, rarity, price, name, des, '[', color, mat1, mat2, volume, \
                                  wgt, dam, 0, to_hit, covers, encumber, dmg_resist, cut_resist,   \
                                  env, warmth, storage))
...
#define GUN(name, rarity, price, color, mat1, mat2, skill, ammo, volume, wgt, melee_dam, to_hit,   \
    ...
    itypes.push_back(new it_gun(index, rarity, price, name, des, '(', color, mat1, mat2, volume,   \
                                wgt, melee_dam, 0, to_hit, skill, ammo, dmg, accuracy, recoil,     \
...
#define GUNMOD(name, rare, value, color, mat1, mat2, volume, weight, meleedam, meleecut, meleehit, \
               acc, damage, loudness, clip, recoil, burst, newtype, pistol, shotgun, smg, rifle,   \
               a_a_t, des)                                                                         \
    index++;                                                                                       \
    itypes.push_back(new it_gunmod(index, rare, value, name, des, ':', color, mat1, mat2, volume,  \
                                   weight, meleedam, meleecut, meleehit, acc, damage, loudness,    \
                                   clip, recoil, burst, newtype, a_a_t, pistol, shotgun, smg,      \
                                   rifle))
...
reduction in accuracy.");
    ...
    //	NAME      	 RAR  PRC  COLOR     MAT1   MAT2     VOL WGT DAM CUT HIT
    GUNMOD(
        "5.7mm caliber retool", 1, 460, c_green, STEEL, MNULL, 1, 1, -3, 0, -1,
        //	ACC DAM NOI CLP REC BST NEWTYPE,	PISTOL	SHOT	SMG	RIFLE
...
penetration.");
    ...
    GUNMOD(
        "4.6mm caliber retool", 1, 460, c_green, STEEL, MNULL, 1, 1, -3, 0, -1, -1, 0, 0, 0, 0, 0,
        AT_46, true, false, true, false,
        (flag_to_bit_position(AT_22) | flag_to_bit_position(AT_9MM) | flag_to_bit_position(AT_38)),
        "\
...
armor penetration.");
    ...
    GUNMOD(".308 caliber retool", 2, 520, c_green, STEEL, MNULL, 2, 1, 4, 0, 1,
           ...
           (flag_to_bit_position(AT_SHOT) | flag_to_bit_position(AT_762)
            | flag_to_bit_position(AT_223) | flag_to_bit_position(AT_3006)),
           "\
...
//  * Others??
#define CONT(name, rarity, price, color, mat1, mat2, volume, wgt, melee_dam, to_hit, contains,     \
             flags, des)                                                                           \
    index++;                                                                                       \
...
#define TOOL(name, rarity, price, sym, color, mat1, mat2, volume, wgt, melee_dam, melee_cut,       \
             to_hit, max_charge, def_charge, charge_per_use, charge_per_sec, fuel, revert, func,   \
             des)                                                                                  \
    index++;                                                                                       \
    itypes.push_back(new it_tool(index, rarity, price, name, des, sym, color, mat1, mat2, volume,  \
                                 wgt, melee_dam, melee_cut, to_hit, max_charge, def_charge,        \
