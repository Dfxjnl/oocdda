#ifndef OOCDDA_DIALOGUE_HPP
#define OOCDDA_DIALOGUE_HPP
...
std::string talk_bad_names[10] = { "punk", "bitch", "mark", "asshole", "fucker", "sucker",
    "fuckwad", "fuckface", "motherfucker", "shithead" };

std::string talk_good_names[10] = { "stranger", "friend", "pilgrim", "traveler", "pal", "fella",
    "you", "dude", "buddy", "man" };
...
std::string ill_die[10] = { "I'm not gonna last much longer", "I'll be dead soon",
    "I'll be a goner", "I'm dead, <name_g>,", "I'm dead meat", "I'm in serious trouble",
    "I'm doomed", "I'm done for", "I won't last much longer", "my days are numbered" };
...
std::string talk_needs[num_needs][5] = {
    ...
    { "Got anything I can use as a weapon?",     "<ill_die> without a good weapon<punc>",
     "I'm sick of fighting with my <mywp>, got something better?",                                                                 "Hey <name_g>, care to sell me a weapon?",
     "My <mywp> just won't cut it, I need a real weapon..."                                                                                                                                },
    { "Hey <name_g>, I could really use a gun.",
     "Hey, you got a spare gun?  It'd be better than my <mywp><punc>",                    "<ill_die> if I don't find a gun soon!", "<name_g><punc> Feel like selling me a gun?",
     "I need a gun, any kind will do!"                                                                                                                                                     },
    { "I could use some food, here.",            "I need some food, real bad!",
     "Man, am I glad to see you!  Got any food to trade?",                                                                         "<ill_die> unless I get some food in me... got any?",
     "Please tell me you have some food to trade!"                                                                                                                                         },
    { "Got anything to drink?",                  "I need some water or something.",
     "<name_g>, I need some water... got any?",                                                                                    "<ill_die> without something to drink.",
...
std::string talk_hands_up[10] = { "Put your hands up!", "Put your hands up, <name_b>!",
    "Reach for the sky!", "Hands up!", "Hands in the air!", "Hands up, <name_b>!",
    "Hands where I can see them!", "Okay <name_b>, hands up!", "Okay <name_b><punc> hands up!",
